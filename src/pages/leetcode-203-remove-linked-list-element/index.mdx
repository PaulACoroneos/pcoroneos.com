...
<Image src='/remove-linked-list-element-1.jpg' alt='a linked list composed of nodes 3,2,3 and 1 respectively.' height={480} width={600} layout='fixed'/>
...
<Image src='/remove-linked-list-element-2.jpg' alt='a linked list composed of nodes 3,2, 3 and 1 where 3 is now pointing to the other node of value 3 with 2 fully disconnected. Prev pointer points to first node 3 and current points to node with value 2.' height={480} width={600} layout='fixed' />

<Image src='/remove-linked-list-element-3.jpg' alt='a linked list composed of nodes 3,3 and 1 respectively after node 2 is removed.' height={480} width={600} layout='fixed'/>
...
<Image src='/remove-linked-list-element-4.jpg' alt='showing the head, prev and curr pointer in our linked list and then showing that even after moving curr pointer in case target value is at head there is no change to linked list whatsoever.' height={480} width={600} layout='fixed'/>
...
<Image src='/remove-linked-list-element-5.jpg' alt='A linked list where a sentinel node with no value is added pointing its next pointer to the head.' height={480} width={600} layout='fixed'/>
...
<Image src='/remove-linked-list-element-6.jpg' alt="3 at head of linked list is now able to be removed by pointing sentinel pointer to node 2" height={480} width={600} layout='fixed'/>
