...
Today my primary focus involves primarily front end concerns (React, TypeScript, Redux, graphql, tailwind, css-in-js, etc.). But as a constant learner I am also looking into backend technologies, AWS and even machine learning. It is my hope over time to have a wide range of knowledge that can be applied to a variety of problems.
