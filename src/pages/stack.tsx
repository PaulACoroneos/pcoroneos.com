...
import { StyledImage } from '../components/blog-post/blog-post.styles';
...
const Stack: React.FC = () => <BlogPost header='My first stack' date='2020-01-15' src='stack-wood.jpg' alt='A stack of chopped firewood' desc='Chopping firewood is a lot harder than implementing your own stack'>
  <p>{'For a long time i\'ve wanted to learn data structures and algorithms. I decided with the new year it was finally time to get started. After all the best time to start something was yesterday. The next best time is today.'}</p>
