...
const Leetcode: React.FC = () =>
  <div className='divide-y divide-gray-200'>
    <Head>
      ...
      <meta name='twitter:image' content='https://pcoroneos.com/paulcoroneos.jpg' />
      ...
      <meta property='og:image' content='https://pcoroneos.com/paulcoroneos.jpg' />
    ...
    <ul className='divide-y divide-gray-200'>
      {posts.filter(post => post.module.meta.date).filter(post => post.module.meta?.tag?.includes('leetcode')).map(({ link, module: { default: Component, meta } }, idx) =>
