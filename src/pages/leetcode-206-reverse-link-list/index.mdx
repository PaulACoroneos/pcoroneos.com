...
<Image src='/basic-linked-list.jpg' alt='A basic singly linked list of 1, 2 and 3.' />
...
<Image src='/linked-list-prev-curr-step-one.jpg' alt='Linked list at first iteration of reverse algorithm' />
...
<Image src='/linked-list-prev-curr-step-two.jpg' alt='Linked list at second iteration of reverse algorithm' />
...
<Image src='/linked-list-prev-curr-step-three.jpg' alt='Linked list at second iteration of reverse algorithm with next pointer shown' />
...
<Image src='/linked-list-prev-curr-step-four.jpg' alt='Linked list with curr and prev pointer shifted at end of first loop.' />
...
<Image src='/linked-list-prev-curr-step-five.jpg' alt='start of second loop where next pointer is defined as current pointers next pointer.' />

<Image src='/linked-list-prev-curr-step-six.jpg' alt='node 2 next pointer now points to node 1 disconnecting list from node 3' />

<Image src='/linked-list-prev-curr-step-seven.jpg' alt='previous and current pointers are moved to nodes 2 and 3 respectively' />
...
<Image src='/linked-list-prev-curr-step-eight.jpg' alt='final reversed linked list with prev pointing to new linked list head.' />
...
<Image src='/linked-list-recursive-one.jpg' alt='Linked list unaffected with one reverseList() call placed on call stack' />

Now let's fast forward two more steps and glance at the call stack:

<Image src='/linked-list-recursive-two.jpg' alt='Linked list unaffected with three reverseList() calls on call stack.' />
...
<Image src='/linked-list-recursive-four.jpg' alt='Linked list with nodes 3 and 2 pointing to each other.' />
...
<Image src='/linked-list-recursive-five.jpg' alt='Linked list with nodes 3 pointing to node 2 alone.' />
...
<Image src='/linked-list-recursive-seven.jpg' alt='step one of reverseList(node 1). nodes 1 and 2 now point to each other' />

Step 2: We delete the pointer from node 1 to node 2 by setting it to null. This makes node 1 the new tail node

<Image src='/linked-list-recursive-eight.jpg' alt='step two of reverseList(node 1). node 1 next is set to null so that only node 2 pointing to node 1 only exists' />
