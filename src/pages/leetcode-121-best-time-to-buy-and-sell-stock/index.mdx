...
export const meta = {
  ...
  tag:['leetcode','array','dynamic-programming']
};
...
<Image src='/best-time-buy-and-sell-stock.jpg' alt='peak and valley diagram example 1' layout="responsive" width={600} height={400} />
