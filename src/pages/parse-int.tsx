...
const ParseInt = () => <BlogPost header='Big trouble with parseInt()' date='2019-11-28' src='code.jpg' alt='transpiled javascript on a computer screen' desc={'I am glad we don\'t code in transpiled javascript!'}>
