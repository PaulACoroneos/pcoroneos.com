export const BLOG_POST_LINK_DATA = [{
  ...
  description: 'Procrastination and imposter theory are real things. It\'s so easy to convince yourself you aren\'t ready for something. But these are simply excuses. The best time to have started something was yesterday. The next best time is now.'
},
{
  href: 'stack',
  title: 'My first stack',
  date: '2020-01-15',
  description: 'For a long time i\'ve wanted to learn data structures and algorithms. I decided with the new year it was finally time to get started. After all the best time to start something was yesterday. The next best time is today.'
},
{
  href: 'updating-bootcamp',
...
},
{
  href: 'role-tab',
  date: '2019-12-06',
  title: 'Using caution with aria-selected and role="tab"',
  description: 'As a front end developer one my weak areas is a11y. I was working a bug today at work involving an implementation that utilized tabs. Per my coworker in order for the feature to work I needed to utilize aria-selected and aria-controls.'
},
{
  href: 'parse-int',
  date: '2019-11-28',
