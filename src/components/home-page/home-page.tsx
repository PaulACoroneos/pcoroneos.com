...
export const HomePage: React.FC = () =>
  <HomePageWrapper>
    ...
    <StyledSection>
      ...
      <BlogContent>
        <BlogLink href='next-best-time' date='2020-01-22' title='The next best time is now' description={'Procrastination and imposter theory are real things. It\'s so easy to convince yourself you aren\'t ready for something. But these are simply excuses. The best time to have started something was yesterday. The next best time is now.'} />
        <BlogLink href='stack' title='My first stack' date='2020-01-15' description={'For a long time i\'ve wanted to learn data structures and algorithms. I decided with the new year it was finally time to get started. After all the best time to start something was yesterday. The next best time is today.'} />
