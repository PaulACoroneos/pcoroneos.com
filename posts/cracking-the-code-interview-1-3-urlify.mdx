...
Hello everyone and welcome back! Today we will be discussing my solution to Cracking the Code Interview 1-3 - Urlify. Let's start out with the prompt (first thing we should do when given an algorithm!):
